...
def check_prisma_schema_diff_helper(
    db_url: str, scheme_path: str
) -> Tuple[bool, List[str]]:
...
def check_prisma_schema_diff(
    ...
    has_diff, message = check_prisma_schema_diff_helper(db_url, scheme_path)
    if has_diff:
        raise Exception(
